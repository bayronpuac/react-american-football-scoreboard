    ...
    <div className="container">
      ...
      <section className="buttons">
        ...
        <div className="awayButtons">
          <button onClick={() => setHome(away + 7)} className="awayButtons__touchdown" >Away Touchdown</button>
          <button onClick={() => setHome(away + 3)} className="awayButtons__fieldGoal">Away Field Goal</button>
        </div>
      </section>
    </div>
  );
